...
export const runtimeProtocolGrpc = 'sophia.runtime.v1.grpc'
export const runtimeMetadataHeader = 'X-Sophia-Runtime-Metadata'
...
export interface RuntimeHandshakeHeaders {
  ...
  'X-Sophia-Runtime-Metadata': string
  'X-Team-ID'?: string
}
...
export function handshakeHeaders(
  ...
  const headers: RuntimeHandshakeHeaders = {
    ...
    'X-Sophia-Runtime-Metadata': encodeHandshakeMetadata(metadata),
  }
