---
name: hooks-setup
description: Configure Sophia hooks in /data/.sophia/hooks.json, including events, matchers, command/tool actions, decisions, on_error behavior, append_context, and validation. Use when the user asks to inspect, create, update, debug, or explain workspace hooks.
---

# Hooks Setup

Use this skill when the user wants to inspect, create, update, debug, or explain Sophia hooks.

## Files

- User hooks live at `/data/.sophia/hooks.json`.
...
If `/data/.sophia/hooks.json` is missing, create:
