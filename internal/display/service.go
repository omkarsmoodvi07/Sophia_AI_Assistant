...
const (
	...
	gstLaunchEnv         = "SOPHIA_GSTREAMER_LAUNCH"
	rtcUDPPortMinEnv     = "SOPHIA_DISPLAY_WEBRTC_UDP_PORT_MIN"
	rtcUDPPortMaxEnv     = "SOPHIA_DISPLAY_WEBRTC_UDP_PORT_MAX"
	rtcNATIPsEnv         = "SOPHIA_DISPLAY_WEBRTC_NAT_IPS"
	forceVP8Env          = "SOPHIA_DISPLAY_FORCE_VP8"
...
func (s *Service) Screenshot(ctx context.Context, botID string) ([]byte, string, error) {
	...
	output, err := os.CreateTemp("", "sophia-display-*.jpg")
	if err != nil {
		return nil, "", err
	}
