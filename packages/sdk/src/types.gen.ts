...
export type GithubComSophiaaiSophiaInternalMcpConnection = {
    auth_type?: string;
    bot_id?: string;
    config?: {
        [key: string]: unknown;
...
export type McpListResponse = {
    items?: Array<GithubComSophiaaiSophiaInternalMcpConnection>;
};
...
export type PostBotsByBotIdMcpResponses = {
     ...
     * Created
     */
    201: GithubComSophiaaiSophiaInternalMcpConnection;
};
...
export type GetBotsByBotIdMcpByIdResponses = {
     ...
     * OK
     */
    200: GithubComSophiaaiSophiaInternalMcpConnection;
};
