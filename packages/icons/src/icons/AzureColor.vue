<template>
  ...
  ><path
    ...
    :fill="`url(#${uid}-lobe-icons-azure-fill-0)`"
  /><path
  ...
  /><path
    ...
    :fill="`url(#${uid}-lobe-icons-azure-fill-1)`"
  /><path
    ...
    :fill="`url(#${uid}-lobe-icons-azure-fill-2)`"
  /><defs><linearGradient
    :id="`${uid}-lobe-icons-azure-fill-0`"
  ...
  /></linearGradient><linearGradient
    :id="`${uid}-lobe-icons-azure-fill-1`"
    gradientUnits="userSpaceOnUse"
    x1="14.042"
    x2="12.324"
    y1="15.302"
  ...
  /><stop
    ...
    stop-opacity="0"
  /></linearGradient><linearGradient
    :id="`${uid}-lobe-icons-azure-fill-2`"
    gradientUnits="userSpaceOnUse"
    x1="12.841"
    x2="20.793"
    y1="1.626"
