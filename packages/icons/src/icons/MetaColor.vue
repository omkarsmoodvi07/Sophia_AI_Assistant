<template>
  ...
  ><path
    ...
    :fill="`url(#${uid}-lobe-icons-meta-fill-0)`"
  /><path
    ...
    :fill="`url(#${uid}-lobe-icons-meta-fill-1)`"
  /><path
  ...
  /><path
    ...
    :fill="`url(#${uid}-lobe-icons-meta-fill-5)`"
  /><path
  ...
  /><path
    ...
    :fill="`url(#${uid}-lobe-icons-meta-fill-6)`"
  /><path
  ...
  /><path
    ...
    :fill="`url(#${uid}-lobe-icons-meta-fill-7)`"
  /><path
    ...
    :fill="`url(#${uid}-lobe-icons-meta-fill-8)`"
  /><path
    ...
    :fill="`url(#${uid}-lobe-icons-meta-fill-9)`"
  /><path
  ...
  /><path
    ...
    :fill="`url(#${uid}-lobe-icons-meta-fill-12)`"
  /><defs><linearGradient
    :id="`${uid}-lobe-icons-meta-fill-0`"
    x1="75.897%"
    x2="26.312%"
    y1="89.199%"
    y2="12.194%"
  ...
  /><stop
    ...
    stop-color="#0080F9"
  /></linearGradient><linearGradient
    :id="`${uid}-lobe-icons-meta-fill-10`"
    x1="20.433%"
    x2="82.112%"
    y1="50.001%"
    y2="50.001%"
  ...
  /><stop
    ...
    stop-color="#0279F1"
  /></linearGradient><linearGradient
    :id="`${uid}-lobe-icons-meta-fill-11`"
    x1="40.303%"
    x2="72.394%"
    y1="35.298%"
    y2="57.811%"
  ...
  /><stop
    ...
    stop-color="#0377EF"
  /></linearGradient><linearGradient
    :id="`${uid}-lobe-icons-meta-fill-12`"
    x1="32.254%"
    x2="68.003%"
    y1="19.719%"
    y2="84.908%"
