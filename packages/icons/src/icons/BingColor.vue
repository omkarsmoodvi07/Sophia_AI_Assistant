<template>
  ...
  ><path
    ...
    :fill="`url(#${uid}-lobe-icons-bing-fill-0)`"
  /><path
    ...
    :fill="`url(#${uid}-lobe-icons-bing-fill-1)`"
    fill-rule="nonzero"
  /><path
    ...
    :fill="`url(#${uid}-lobe-icons-bing-fill-2)`"
    fill-rule="nonzero"
  /><defs><radialGradient
    :id="`${uid}-lobe-icons-bing-fill-0`"
    cx="93.717%"
    cy="77.818%"
    fx="93.717%"
    fy="77.818%"
