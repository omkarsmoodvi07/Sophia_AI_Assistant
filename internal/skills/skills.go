...
const (
	...
	IndexDirPath              = config.DefaultDataMount + "/.sophia/skills"
	IndexFilePath             = IndexDirPath + "/index.json"
	PluginDirPath             = config.DefaultDataMount + "/.sophia/plugins"
	SkillDiscoveryRootsEnvVar = "SOPHIA_SKILL_DISCOVERY_ROOTS"
