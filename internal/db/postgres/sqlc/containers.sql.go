...
DELETE FROM containers WHERE team_id = public.sophia_current_team_id() AND bot_id = $1
`
...
SELECT id, bot_id, container_id, container_name, image, status, namespace, auto_start, container_path, workspace_backend, created_at, updated_at, last_started_at, last_stopped_at, team_id FROM containers WHERE team_id = public.sophia_current_team_id() AND bot_id = $1 ORDER BY updated_at DESC LIMIT 1
`
...
SELECT id, bot_id, container_id, container_name, image, status, namespace, auto_start, container_path, workspace_backend, created_at, updated_at, last_started_at, last_stopped_at, team_id FROM containers WHERE team_id = public.sophia_current_team_id() AND auto_start = true ORDER BY updated_at DESC
`
...
WHERE team_id = public.sophia_current_team_id() AND bot_id = $2
`
