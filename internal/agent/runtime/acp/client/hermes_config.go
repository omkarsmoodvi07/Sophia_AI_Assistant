...
const (
	...
	hermesManagedCustomProviderKey    = "sophia-managed"
	hermesManagedCustomProviderName   = "Sophia Managed"
	hermesManagedCustomProviderEnvKey = "SOPHIA_HERMES_API_KEY"
)
...
func renderHermesManagedConfig(data hermesManagedConfigData) ([]byte, error) {
	...
	out.WriteString("# Generated by Sophia for managed Hermes ACP sessions.\n")
